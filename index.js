...
app.get('/invoicelist/:cid', function(req, res) {
...
app.get('/single/invoice/:cid/:id', function(req, res) {
    var cid = req.params.cid;
...
app.post('/invoice/new/:cid', function(req, res) {
    var cid = req.params.cid;
...
app.put('/invoice/update/:cid/:id', function(req, res) {
      var id = req.params.id;
     var cid = req.params.cid;
    var requestBody = JSON.stringify(req.body);
    console.log("Request body: "+requestBody);
...
app.delete('/invoice/delete/:cid/:id', function(req, res) {
    var id = req.params.id;
    var cid = req.params.cid;
